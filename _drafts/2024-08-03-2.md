...
Step 1 : C 第一位必定為0
Step 2 : D 前一位數字0 ，檢查 C ，不一致為 0
Step 3 : C 前一位數字0 ，檢查 C ，一致變為 1
Step 4 : E 前一位數字1 ，檢查 D ，不一致為 0
Step 5 : C 前一位數字0 ，檢查 C ，一致變為 1
Step 6 : D 前一位數字1 ，檢查 D ，一致變為 2
Step 7 : C 前一位數字2 ，檢查 C ，一致變為 3
*/


```

<br/> <img src="/assets/image/Algorithm/StringSearch/KMP/001.png" width="50%" height="50%" />
<br/><br/>
