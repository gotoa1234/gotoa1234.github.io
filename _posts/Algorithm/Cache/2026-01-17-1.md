---
layout: default_post
title:  "0002. LFU(Least Frequently Used Cache) - 快取演算法 (Cache Algorithm) - 快取策略：最近被使用的資料提高優先權重"
excerpt: "演算法-快取策略"
tags:
- "Algorithm Cache"
- "Algorithm"
...
<br/>空間複雜度： O(n)
<br/>範例檔案：<a href="https://github.com/gotoa1234/LeetCodeProblemSolvingBy_C_Sharp/blob/main/LeetCodePractice/LeetcodePractice/Hard/0460_LFU_Cache.cs">Source Code</a>
...
<br/>簡言之：「使用的頻率最少的會被先淘汰」，最近常被用到的物件權重會持續提高，用此演算法通常適合應用需要長期熱點資料，例如 CDN、DNS 快取
<br/>※來源：Wiki
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/002.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/003.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/004.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/005.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/006.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/007.png" width="80%" height="80%">
<br/><br/>
...
<br/> <img src="/assets/image/Algorithm/Cache/LFU/008.png" width="80%" height="80%">
<br/><br/>